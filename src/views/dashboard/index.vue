      ...
      <div class="right">
        ...
        <div class="panel">
          ...
          <div class="information-list">
            <div v-for="(item,index) in HomeNotice" :key="index" class="information-list-item">
              <img :src="item.icon" alt="">
              <div>
                <p>
                  <span class="col">{{ item.notice }}</span>
                </p>
                <p>{{ item.createTime }}</p>
              </div>
            </div>
    ...
    homeData(newValue) {
      ...
      this.myChart1.setOption({
        xAxis: {
          type: 'category',
          boundaryGap: false,
          data: newValue.socialInsurance?.xAxis
        },
        yAxis: {
          type: 'value'
        },
        series: [
          {
            data: newValue.socialInsurance?.yAxis,
            type: 'line',
            areaStyle: {}
          }
        ]
      ...
      this.myChart2.setOption({
        xAxis: {
          type: 'category',
          boundaryGap: false,
          data: newValue.providentFund?.xAxis
        },
        yAxis: {
          type: 'value'
        },
        series: [
          {
            data: newValue.providentFund?.yAxis,
            type: 'line',
            areaStyle: {}
          }
        ]
